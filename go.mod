...
require (
	...
	github.com/openstack-k8s-operators/glance-operator/api v0.3.0
	github.com/openstack-k8s-operators/heat-operator/api v0.3.0
	github.com/openstack-k8s-operators/horizon-operator/api v0.3.0
	github.com/openstack-k8s-operators/infra-operator/apis v0.1.1-0.20231001103054-f74a88ed4971
	github.com/openstack-k8s-operators/ironic-operator/api v0.3.0
	github.com/openstack-k8s-operators/keystone-operator/api v0.3.0
	github.com/openstack-k8s-operators/lib-common/modules/common v0.3.1-0.20231004075925-7a2ccbf0ea0e
	github.com/openstack-k8s-operators/manila-operator/api v0.3.1-0.20231004134924-e000eb86b50b
	...
	github.com/openstack-k8s-operators/octavia-operator/api v0.3.0
	github.com/openstack-k8s-operators/openstack-ansibleee-operator/api v0.3.0
	github.com/openstack-k8s-operators/openstack-baremetal-operator/api v0.3.0
	github.com/openstack-k8s-operators/openstack-operator/apis v0.0.0-20230725141229-4ce90d0120fd
	github.com/openstack-k8s-operators/ovn-operator/api v0.3.0
	...
	github.com/openstack-k8s-operators/telemetry-operator/api v0.3.1-0.20231004131915-7144cbee31e7
...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/openstack v0.3.1-0.20231004075925-7a2ccbf0ea0e //indirect
	github.com/openstack-k8s-operators/lib-common/modules/storage v0.3.1-0.20231004075925-7a2ccbf0ea0e //indirect
