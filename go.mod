...
require (
	...
	github.com/openstack-k8s-operators/glance-operator/api v0.6.1-0.20251125160144-44c334904ddc
	...
	github.com/openstack-k8s-operators/nova-operator/api v0.6.1-0.20251125151736-8f090b5a321c
	github.com/openstack-k8s-operators/octavia-operator/api v0.6.1-0.20251124205123-e5b9b7d2ae28
	github.com/openstack-k8s-operators/openstack-baremetal-operator/api v0.6.1-0.20251125135723-9b1fcb2c3b83
	github.com/openstack-k8s-operators/openstack-operator/api v0.0.0-00010101000000-000000000000
	github.com/openstack-k8s-operators/ovn-operator/api v0.6.1-0.20251125163853-ffe7b280145f
	...
	github.com/openstack-k8s-operators/test-operator/api v0.6.1-0.20251125140040-055184954881
