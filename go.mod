...
require (
	...
	github.com/openstack-k8s-operators/neutron-operator/api v0.6.1-0.20250407141754-e9a93dea9165
	...
	github.com/openstack-k8s-operators/telemetry-operator/api v0.6.1-0.20250408072406-6f66e87ca94f
