...
type OpenStackControlPlaneStatus struct {
	...
	// ContainerImages
	ContainerImages corev1beta1.ContainerImages `json:"containerImages,omitempty"`
...
func (instance *OpenStackControlPlane) InitConditions() {
	...
	cl := condition.CreateList(
		...
		condition.UnknownCondition(corev1beta1.OpenStackControlPlaneMemcachedReadyCondition, condition.InitReason, corev1beta1.OpenStackControlPlaneMemcachedReadyInitMessage),
		...
		condition.UnknownCondition(corev1beta1.OpenStackControlPlaneIronicReadyCondition, condition.InitReason, corev1beta1.OpenStackControlPlaneIronicReadyInitMessage),
		...
		condition.UnknownCondition(corev1beta1.OpenStackControlPlaneManilaReadyCondition, condition.InitReason, corev1beta1.OpenStackControlPlaneManilaReadyInitMessage),
		condition.UnknownCondition(corev1beta1.OpenStackControlPlaneHorizonReadyCondition, condition.InitReason, corev1beta1.OpenStackControlPlaneHorizonReadyInitMessage),
		condition.UnknownCondition(corev1beta1.OpenStackControlPlaneDNSReadyCondition, condition.InitReason, corev1beta1.OpenStackControlPlaneDNSReadyInitMessage),
		condition.UnknownCondition(corev1beta1.OpenStackControlPlaneTelemetryReadyCondition, condition.InitReason, corev1beta1.OpenStackControlPlaneTelemetryReadyInitMessage),
		condition.UnknownCondition(corev1beta1.OpenStackControlPlaneHeatReadyCondition, condition.InitReason, corev1beta1.OpenStackControlPlaneHeatReadyInitMessage),
		condition.UnknownCondition(corev1beta1.OpenStackControlPlaneSwiftReadyCondition, condition.InitReason, corev1beta1.OpenStackControlPlaneSwiftReadyInitMessage),
		condition.UnknownCondition(corev1beta1.OpenStackControlPlaneOctaviaReadyCondition, condition.InitReason, corev1beta1.OpenStackControlPlaneOctaviaReadyInitMessage),
		condition.UnknownCondition(corev1beta1.OpenStackControlPlaneDesignateReadyCondition, condition.InitReason, corev1beta1.OpenStackControlPlaneDesignateReadyInitMessage),
		condition.UnknownCondition(corev1beta1.OpenStackControlPlaneBarbicanReadyCondition, condition.InitReason, corev1beta1.OpenStackControlPlaneBarbicanReadyInitMessage),
		condition.UnknownCondition(corev1beta1.OpenStackControlPlaneRedisReadyCondition, condition.InitReason, corev1beta1.OpenStackControlPlaneRedisReadyInitMessage),
		condition.UnknownCondition(corev1beta1.OpenStackControlPlaneCAReadyCondition, condition.InitReason, corev1beta1.OpenStackControlPlaneCAReadyInitMessage),
		condition.UnknownCondition(corev1beta1.OpenStackControlPlaneOpenStackVersionInitializationReadyCondition, condition.InitReason, corev1beta1.OpenStackControlPlaneOpenStackVersionInitializationReadyInitMessage),
