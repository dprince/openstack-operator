...
// FooControlPlaneSpec defines the desired state of FooControlPlane
type FooControlPlaneSpec struct {
	...
	// +kubebuilder:validation:Optional
	// Telemetry - Parameters related to the Foo Telemetry services
	...
	ExtraMounts []FooExtraVolMounts `json:"extraMounts,omitempty"`
}
...
type TLSPodLevelConfig struct {
	...
	// Internal - default CA used for all FooControlPlane and FooDataplane endpoints,
	...
	// +operator-sdk:csv:customresourcedefinitions:type=spec
	// +kubebuilder:default={ca: {duration: "87600h"}, cert: {duration: "43800h"}}
	// Libvirt - CA used for libvirt/qemu services on FooControlPlane and FooDataplane
	Libvirt CertSection `json:"libvirt"`

	// +kubebuilder:validation:Optional
	// +operator-sdk:csv:customresourcedefinitions:type=spec
	// +kubebuilder:default={ca: {duration: "87600h"}, cert: {duration: "43800h"}}
	// Ovn - CA used for all OVN services on FooControlPlane and FooDataplane
...
// TelemetrySection defines the desired state of Foo Telemetry services
type TelemetrySection struct {
	// +kubebuilder:validation:Optional
	// +kubebuilder:default=true
	// +operator-sdk:csv:customresourcedefinitions:type=spec,xDescriptors={"urn:alm:descriptor:com.tectonic.ui:booleanSwitch"}
	// Enabled - Whether Foo Telemetry services should be deployed and managed
	Enabled bool `json:"enabled"`

	// +kubebuilder:validation:Optional
	//+operator-sdk:csv:customresourcedefinitions:type=spec
	// Template - Overrides to use when creating the Foo Telemetry services
...
// FooControlPlaneStatus defines the observed state of FooControlPlane
...
// +operator-sdk:csv:customresourcedefinitions:displayName="Foo ControlPlane"
// +kubebuilder:resource:shortName=osctlplane;osctlplanes;oscp;oscps
//+kubebuilder:printcolumn:name="Status",type="string",JSONPath=".status.conditions[0].status",description="Status"
//+kubebuilder:printcolumn:name="Message",type="string",JSONPath=".status.conditions[0].message",description="Message"

// FooControlPlane is the Schema for the openstackcontrolplanes API
...
// FooControlPlaneList contains a list of FooControlPlane
...
// FooExtraVolMounts exposes additional parameters processed by the openstack-operator
// and defines the common VolMounts structure provided by the main storage module
type FooExtraVolMounts struct {
	// +kubebuilder:validation:Optional
	//+operator-sdk:csv:customresourcedefinitions:type=spec
...
func init() {
	SchemeBuilder.Register(&FooControlPlane{}, &FooControlPlaneList{})
}

// IsReady - returns true if service is ready to serve requests
func (instance FooControlPlane) IsReady() bool {
	return instance.Status.Conditions.IsTrue(condition.ReadyCondition)
}

// InitConditions - Initializes Status Conditons
func (instance *FooControlPlane) InitConditions() {
...
func (instance FooControlPlane) GetPublicIssuer() string {
...
func (instance FooControlPlane) GetInternalIssuer() string {
	// use custom issuer if set
...
func (instance FooControlPlane) GetOvnIssuer() string {
	// use custom issuer if set
...
func (instance FooControlPlane) GetLibvirtIssuer() string {
	// use custom issuer if set
